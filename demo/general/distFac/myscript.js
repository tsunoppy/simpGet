...
window.onload = function (){
    ...
    document.getElementById('nStory').value = nStory;
    MakeStory(nStory);

    DrawSec();
}

function MakeStory(nStory){
    ...
    var span = Number( document.getElementById('l').value ) ;
	...
	result += 'Height';
	result += '</td><td>';
	result += 'Left: gb, gD, Span';
	result += '</td><td>';
	result += 'Right: gb, gD, Span';
	result += '</td></tr>';
	//
	result += '<tr><td>';
	result += (nStory-i+1);
	result += '</td><td>';
	result += '<input type="text" id="height' + i + '" onChange="DrawSec();">';
	result += '</td><td>';
	result += '<input type="text" id="gbL' + i + '" onChange="DrawSec();">';
	result += 'x';
	result += '<input type="text" id="gdL' + i + '" onChange="DrawSec();">';
	result += 'x';
	result += '<input type="text" id="spanL' + i + '" onChange="DrawSec();">';
	result += '</td><td>';
	result += '<input type="text" id="gbR' + i + '" onChange="DrawSec();">';
	result += 'x';
	result += '<input type="text" id="gdR' + i + '" onChange="DrawSec();">';
	result += 'x';
	result += '<input type="text" id="spanR' + i + '" onChange="DrawSec();">';
	result += '</td></tr>';

    }

    document.getElementById('addBeam').innerHTML = result;

    for( i=1; i<=nStory, i++;){
	document.getElemenbById('height'+i).value = h;
	document.getElemenbById('gbL'+i).value = gb;
	document.getElemenbById('gdL'+i).value =gd;
	document.getElemenbById('spanL'+i).value = span;
	document.getElemenbById('gbR'+i).value = gb;
	document.getElemenbById('gdR'+i).value =gd;
	document.getElemenbById('spanR'+i).value = span;
	document.getElemenbById('height'+i).value = h;
    }
...
function OnButtonClick(){
    ...
    document.getElementById('result').innerHTML = result;w
